...
public class ListViewCustomAdapter extends BaseAdapter {
    ...
    public ListViewCustomAdapter(Activity context, String[] Names, String[] Date, String[] Image1, String[] Image2, int[] ID) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if(convertView==null)
            {
                ...
                convertView = inflater.inflate(R.layout.medication_dairy_row_layout, null);
